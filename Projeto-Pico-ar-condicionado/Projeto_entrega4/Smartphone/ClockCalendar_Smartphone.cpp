...
class ClockCalendar_Smartphone : public ClockCalendar_base
{
private:
public:
  ClockCalendar_Smartphone(string new_data, string new_hora);
};

ClockCalendar_Smartphone::ClockCalendar_Smartphone(string new_data, string new_hora)
{
