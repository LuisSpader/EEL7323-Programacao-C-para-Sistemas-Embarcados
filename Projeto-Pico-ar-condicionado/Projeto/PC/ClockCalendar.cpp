...
public:
  ...
  ClockCalendar(string new_data, string new_hora);
...
ClockCalendar::ClockCalendar(string new_data, string new_hora)
// ClockCalendar::ClockCalendar(string new_data= "00/00/0000", string new_hora = "00:00:00")
{
