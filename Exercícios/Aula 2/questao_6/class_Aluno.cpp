...
void class_Aluno::setMatricula(int newMatricula)
{ //* Numéro de matrícula deve ser único
  matricula = newMatricula;
}

void class_Aluno::setNota1(float newNota)
{
...
void class_Aluno::setNota2(float newNota)
{
  if ((newNota >= 0) && (newNota <= 100))
    nota2 = newNota;
  else
...
int class_Aluno::getMatricula()
{
  return matricula;
}

float class_Aluno::getNota1()
{
  return nota1;
}

float class_Aluno::getNota2()
{
  return nota2;
}

float class_Aluno::getMedia()
{
